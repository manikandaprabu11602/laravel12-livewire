            ...
            <div class="row g-4 mb-4">
                    ...
                    <div class="card" style="--cui-card-cap-bg: #3b5998">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use
                                    xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-facebook-f">
                                </use>
                            </svg>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card" style="--cui-card-cap-bg: #00aced">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-twitter">
                                </use>
                            </svg>
                            <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card" style="--cui-card-cap-bg: #4875b4">
                        <div class="card-header position-relative d-flex justify-content-center align-items-center">
                            <svg class="icon icon-3xl text-white my-4">
                                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-linkedin">
                                </use>
                            </svg>
                            <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use
                                                    xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-google">
                                                </use>
                                            </svg>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use
                                                    xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-twitter">
                                                </use>
                                            </svg>
                                            <div>Twitter</div>
                                    ...
                                    <div class="progress-group">
                                        <div class="progress-group-header">
                                            <svg class="icon icon-lg me-2">
                                                <use
                                                    xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-linkedin">
                                                </use>
                                            </svg>
                                            <div>LinkedIn</div>
                                    ...
                                    <tbody>
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-us">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-mastercard">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-br">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-visa">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-in">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-stripe">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-fr">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-paypal">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-es">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-apple-pay">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-pl">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <svg class="icon icon-xl">
                                                    <use
                                                        xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-amex">
                                                    </use>
                                                </svg>
                                            </td>
                                            <td>

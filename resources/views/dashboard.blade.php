...
<html lang="en">
    ...
    <div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
      ...
      <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
        ...
        <li class="nav-item"><a class="nav-link" href="typography.html">
            <svg class="nav-icon">
            <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-pencil"></use>
            </svg> Typography</a></li>
          ...
          <ul class="nav-group-items compact">
            ...
            <li class="nav-item"><a class="nav-link" href="https://coreui.io/bootstrap/docs/components/calendar/" target="_blank"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Calendar
                <svg class="icon icon-sm ms-2">
                  <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-external-link"></use>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
            <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-cursor"></use>
            </svg> Buttons</a>
          <ul class="nav-group-items compact">
        ...
        <li class="nav-item"><a class="nav-link" href="charts.html">
            <svg class="nav-icon">
            <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-chart-pie"></use>
            </svg> Charts</a></li>
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
            <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-notes"></use>
            </svg> Forms</a>
          <ul class="nav-group-items compact">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
            <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-star"></use>
            </svg> Icons</a>
          <ul class="nav-group-items compact">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            <svg class="nav-icon">
            <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-bell"></use>
            </svg> Notifications</a>
          <ul class="nav-group-items compact">
        ...
        <li class="nav-item"><a class="nav-link" href="widgets.html">
            <svg class="nav-icon">
            <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-calculator"></use>
        ...
        <div class="container-fluid border-bottom px-4">
          ...
          <ul class="header-nav">
            ...
            <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-md"><img class="avatar-img" src="{{ asset('coreui/assets/img/avatars/8.jpg') }}" alt="user@email.com"></div></a>
              <div class="dropdown-menu dropdown-menu-end pt-0">
                ...
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-bell"></use>
                  ...
                  <svg class="icon me-2">
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-envelope-open"></use>
                  </svg> Messages<span class="badge badge-sm bg-success ms-2">42</span></a><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-task"></use>
                  </svg> Tasks<span class="badge badge-sm bg-danger ms-2">42</span></a><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-comment-square"></use>
                ...
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-user"></use>
                  ...
                  <svg class="icon me-2">
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-settings"></use>
                  </svg> Settings</a><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-credit-card"></use>
                  </svg> Payments<span class="badge badge-sm bg-secondary ms-2">42</span></a><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-file"></use>
                  </svg> Projects<span class="badge badge-sm bg-primary ms-2">42</span></a>
                <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-lock-locked"></use>
                  </svg> Lock Account</a><a class="dropdown-item" href="#">
                  <svg class="icon me-2">
                <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/free.svg') }}#cil-account-logout"></use>
                  </svg> Logout</a>
              </div>
            </li>
          </ul>
          ...
          <div class="row g-4 mb-4">
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="card" style="--cui-card-cap-bg: #00aced">
                <div class="card-header position-relative d-flex justify-content-center align-items-center">
                  <svg class="icon icon-3xl text-white my-4">
                    <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-twitter"></use>
                  </svg>
                  <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="progress-group">
                        <div class="progress-group-header">
                          <svg class="icon icon-lg me-2">
                  <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-google"></use>
                          </svg>
                    ...
                    <table class="table border mb-0">
                      ...
                      <tbody>
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-us"></use>
                            </svg>
                          </td>
                          <td>
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-mastercard"></use>
                            </svg>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-br"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-visa"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-in"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-stripe"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-fr"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-paypal"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-es"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-apple-pay"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
                        ...
                        <tr class="align-middle">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/flag.svg') }}#cif-pl"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                          ...
                          <td class="text-center">
                            <svg class="icon icon-xl">
                              <use xlink:href="{{ asset('node_modules/@coreui/icons/sprites/brand.svg') }}#cib-cc-amex"></use>
                            </svg>
                          </td>
                          <td>
                            <div class="small text-body-secondary">Last login</div>
  ...
  <!-- additional plugins are included within coreui/js/ if needed -->
    <script> 
    </script>
  </body>
</html>